    ...
    internal class AppSettingsRenewalParamsReader : IAppSettingsRenewalParamsReader
    {
        ...
        private SharedRenewalParameters GetSharedParams()
        {
            return new SharedRenewalParameters(
                ...
                GetCommonSetting(Constants.OtherSiteResourceGroupKey),
                GetCommonSetting(Constants.StorageConnectionString),
                GetCommonSetting(Constants.StorageContainer),
        ...
        private RenewalParameters GetWebAppRenewalInfo(string webApp, SharedRenewalParameters sharedRenewalParams)
        {
            ...
            try
            {
                return new RenewalParameters(
                    ...
                    groupName,
                    siteSlotName,
                    ResolveOptionalSetting(Constants.OtherSiteResourceGroupKey, webApp, sharedRenewalParams.OtherWebAppResourceGroup),
                    ResolveOptionalSetting(Constants.OtherSiteName, webApp),
                    ResolveOptionalSetting(Constants.OtherSiteSlotName, webApp),
                    ResolveOptionalSetting(Constants.StorageConnectionString, webApp),
